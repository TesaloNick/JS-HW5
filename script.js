...
function returnArray() {
    let arr4First = prompt('Задание 4. Введите первый элемент массива', '3');
    let arr4Last = prompt('Задание 4. Введите последний элемент массива', '10');
...
function checkEmail(a) {
    for (let i=0; i < a.length; i++) { // ввод только лат.букв, цифр и спецсимволов '_', '-', '.', '@'
        if (((a[i] === '_') || (a[i] === '-') || (a[i] === '.') || (a[i] === '@') || ((a[i].charCodeAt() >= 65) && (a[i].charCodeAt() <= 90)) || ((a[i].charCodeAt() >= 97) && (a[i].charCodeAt() <= 122)) || ((a[i].charCodeAt() >= 48) && (a[i].charCodeAt() <= 57)))) {
            ...
            document.write('Вы ввели неправильный символ<br>');
            break;
        }
    }
    for (let j=0; j < arraySymbol.length; j++) { // неввод первым и последним элементом
        for (let i=0; i < a.length; i++) {
            if ((a[0] === arraySymbol[j]) || (a[a.length-1] === arraySymbol[j])) {
                document.write('Вы ввели небуквенный символ первым или последним элементом в названии почты<br>');
                break;
            }
        }
    }
        ...
        for (let n=0; n < arraySymbol.length; n++) {
            for (let i=0; i < a.length; i++) {
                if (!((a[i] === arraySymbol[j]) && (a[i+1] === arraySymbol[n]))) {  
                    ...
                    document.write('Вы ввели небуквенные символы один за одним<br>');
                    break;
                }
            }
        }
    ...
    for (let i=0; i < a.length; i++) { // имя почты больше 2 символов
        if (a[i] === '@') {
            if (a[i-2]){
                ...
                document.write('Имя почты должно быть больше двух символов<br>')
                break;
            }
        } else {
            continue;
        ...
        if (a[i] === '@') {
            for (let j=0; j <= i-1; j++) {
                ...
                if ((a[j].charCodeAt() >= 48 && a[j].charCodeAt() <= 57) || ((a[j].charCodeAt() >= 65) && (a[j].charCodeAt() <= 90)) || ((a[j].charCodeAt() >= 97) && (a[j].charCodeAt() <= 122)) || a[j].charCodeAt() === 46){
                    ...
                    document.write('Имя почты должно состоять из букв, цифр и точки<br>')
                    break;
                }
            }
        }
    ...
    for (let i=0; i < a.length; i++) {  // Имя почты не должно начинаться с цифры
        if (a[0].charCodeAt() >= 48 && a[0].charCodeAt() <= 57) {
            document.write('Имя почты не должно начинаться с цифры<br>')
            break;
        } else {
            continue;
        }
